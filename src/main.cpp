...
int main() {
  ...
  std::vector<SDLA::Rendering::SpriteInfo*> headGrid;
  headGrid.push_back(new SDLA::Rendering::SpriteInfo());
  headGrid[0]->pos.worldPos.x = 32;
  headGrid[0]->pos.worldPos.y = 26;
  int spacing = 8;
  int i = 0;
  ...
  // SDLA::Rendering::Sprite::addImage(0,headInfo);
  ...
  SDLA::Rendering::Sprite::addImageGroup(0,headGrid);
  SDLA::Rendering::Sprite::addImageGroup(0,bodyGrid);
