...
namespace FK{
  namespace AT{
    ...
    std::vector<std::shared_ptr<Sprite>> addSpriteGroup(std::string window, int layer, std::shared_ptr<Information> groupInformation, std::vector<std::shared_ptr<SpriteInformation>> group);
